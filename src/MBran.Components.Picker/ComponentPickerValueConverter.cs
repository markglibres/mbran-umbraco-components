...
namespace MBran.Components.Picker
{
    ...
    public class ComponentPickerValueConverter : IPropertyValueConverter
    {
        ...
        {
            return propertyType.PropertyEditorAlias.Equals("MBran.Components.Picker",
        ...
        public object ConvertSourceToObject(PublishedPropertyType propertyType, object source, bool preview)
        {
            ...
            var model = new ComponentPickerValue
            {
                ...
                ComponentType = ModelsHelper.Instance.StronglyTypedPublishedContent(targetDocTypeAlias)
